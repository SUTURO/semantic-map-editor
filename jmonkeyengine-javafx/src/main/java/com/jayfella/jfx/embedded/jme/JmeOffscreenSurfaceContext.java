...
public class JmeOffscreenSurfaceContext implements JmeContext {
    ...
    public void setApplication(AbstractJmeApplication app) {
    ...
    public Context getOpenCLContext() {
        return getBackgroundContext().getOpenCLContext();
    }
    ...
    public JoyInput getJoyInput() {
        return getBackgroundContext().getJoyInput();
    }

    @Override
    public TouchInput getTouchInput() {
        return getBackgroundContext().getTouchInput();
    }
